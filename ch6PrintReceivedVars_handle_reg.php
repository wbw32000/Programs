...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
 ...
 <body>
  <h1>Registration Results</h1>
   <?php // ch6PrintReceivedVars_handle_reg.php
    print "<p>Ch6/ch6PrintReceivedVars_handle_reg.php, William BW (wbw(at)programmer.net)</p>";
   /* This script receives seven values from register.html:
   email, password, confirm, year, terms, color, submit */

   // Print received variables:
    print '<p>The values  of the received variable are:</p>';
