  ...
  print "<p>Ch9/ch9Pwelcome.php, William BW (wbw(at)programmer.net)</p>";
   ...
   print "<p>Hello, ";
   if ( isset($_SESSION['email']) ) {  <?php // ch9Pwelcome.php 
  print "<p>Ch9/ch9Pwelcome.php, William BW (wbw(at)programmer.net)</p>";
   ...
   if ( isset($_SESSION['email']) ) {
    ...
    print "Note: _SESSION['email'] is not set. This server's session rights are not accessible beyond the initial file.</p>";
   }
